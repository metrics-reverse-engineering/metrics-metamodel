...
public class MetricsFactoryImpl extends EFactoryImpl implements MetricsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MetricsPackage.APPLICATION: return createApplication();
			case MetricsPackage.OPERATOR: return createOperator();
			case MetricsPackage.OPERAND: return createOperand();
			case MetricsPackage.CLASS: return createClass();
			case MetricsPackage.ATTRIBUTE: return createAttribute();
			case MetricsPackage.METHOD: return createMethod();
			default:
	 ...
	 * @generated
	 */
	public nl.metrics.metrics.Class createClass() {
